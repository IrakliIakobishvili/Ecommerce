...
module.exports.sendMail = function(url, userEmail, userName, token) {
  ...
  let mailOptions = {
    from: "Ecommerce <no-replay.facebook@hotmail.com>",
    to: `${userEmail}`,
    subject: `Confirmation Email - Ecommerce.com`,
    html: `
        <div style='width: 750px;box-sizing: border-box;padding: 115px 90px;display: flex;align-items: center;justify-content: center;background: #F3F3F3;font-family: verdana;text-align: center;'>
            <div style='width: 550px;box-shadow: 0px 1px 2px 2px #E9E9E9;border-radius: 4px;overflow: hidden;background: #fff;justify-content: center;'>
                <header style='background: #4267B2;padding: 55px 0px;text-align: center;font-size: 50px;font-weight: bold;color: #fff;'>Ecommerce</header>
                <h1 style='color: #4c4c4c;font-weight: normal;font-size: 30px;margin: 24px 0px;'>Email Confirmation</h1>
                <p style='margin: 0px;padding: 0px;font-size: 14px;line-height: 22px;color: #717171;margin-bottom: 20px;'>Hey ${userName}, you're almost ready to start enjoying Ecommerce.<br>
